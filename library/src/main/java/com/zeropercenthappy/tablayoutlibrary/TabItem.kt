...
class TabItem(context: Context,
              ...
              private val iconSize: Float = context.dip(30).toFloat(),
              private val textSize: Float = context.sp(14).toFloat(),
    ...
    init {
        val layoutParams = LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT)
    ...
    private fun initTabIcon() {
        ...
        val layoutParams = LinearLayout.LayoutParams(Math.round(iconSize), Math.round(iconSize))
